...
-- 0) DROP + CREATE DB
------------------------------------------------------------
IF DB_ID(N'Restaurant_Ipos_New') IS NOT NULL
BEGIN
    ALTER DATABASE Restaurant_Ipos_New SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE Restaurant_Ipos_New;
END
GO

CREATE DATABASE Restaurant_Ipos_New;
GO

USE Restaurant_Ipos_New;
GO
