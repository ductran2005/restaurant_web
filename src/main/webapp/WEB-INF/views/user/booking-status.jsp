            ...
            <body>
                ...
                <nav class="navbar" id="navbar" style="background:rgba(15,14,12,0.95); backdrop-filter:blur(12px);">
                    ...
                    <div class="nav-links">
                        ...
                        <a href="${pageContext.request.contextPath}/user/booking/status" class="active">Tra cứu booking</a>
                    </div>
                ...
                <div class="lookup-section">
                    ...
                    <div class="search-card">
                        <form method="get" action="${pageContext.request.contextPath}/user/booking/status"
                            class="search-form">
                            ...
                            <c:when test="${not empty booking}">
                                ...
                                <div class="result-card">
                                    ...
                                    <div class="result-actions">
                                        ...
                                        <a href="${pageContext.request.contextPath}/user/booking/create" class="btn-action">
                                ...
                                <c:when test="${not empty bookings}">
                                    ...
                                    <c:forEach var="b" items="${bookings}">
                                        <div class="result-card" style="margin-bottom:16px">
                                            ...
                                            <div class="result-actions">
                                                <a href="${pageContext.request.contextPath}/user/booking/status?code=${b.bookingCode}"
                                                    class="btn-action primary">
                                                    <i class="fa-solid fa-eye"></i> Xem chi tiết
                                                </a>
                                                <c:if test="${b.status == 'CONFIRMED' || b.status == 'PENDING'}">
                                                    <a href="${pageContext.request.contextPath}/user/pre-order?code=${b.bookingCode}"
                                                        class="btn-action">
                                                        <i class="fa-solid fa-utensils"></i> Đặt món trước
                                                    </a>
                                                </c:if>
