    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <head>
                ...
                <title>Ð?t món tru?c — Nhà hàng Huong Vi?t</title>
            ...
            <body>
                ...
                <nav class="navbar" id="navbar">
                    <a href="${pageContext.request.contextPath}/" class="nav-logo">
                        ...
                        <div class="nav-logo-text">Huong Vi?t<span>Nhà hàng & Quán nh?u</span></div>
                    </a>
                    <div class="nav-links">
                        <a href="${pageContext.request.contextPath}/user/menu">Th?c don</a>
                        <a href="${pageContext.request.contextPath}/user/booking/create">Ð?t bàn</a>
                        <a href="${pageContext.request.contextPath}/user/booking/status">Tra c?u</a>
                        <a href="${pageContext.request.contextPath}/user/pre-order" class="active">Ð?t món tru?c</a>
                        <a href="${pageContext.request.contextPath}/about">V? chúng tôi</a>
                        <a href="${pageContext.request.contextPath}/contact">Liên h?</a>
                    </div>
                ...
                <section class="preorder-hero">
                    <div class="section-label"><i class="fa-solid fa-utensils"></i> Ð?t món tru?c</div>
                    <h1>Chu?n b? <em>b?a ti?c</em> hoàn h?o</h1>
                    <p>Ð?t món tru?c khi d?n nhà hàng. Món an s? du?c chu?n b? s?n sàng khi b?n t?i.</p>
                </section>
                        ...
                        <c:when test="${empty booking}">
                            ...
                            <div class="lookup-card">
                                <h3
                                    ...
                                    <i class="fa-solid fa-ticket" style="color:var(--primary)"></i> Nh?p mã d?t bàn
                                </h3>
                                <form method="get" action="${pageContext.request.contextPath}/user/pre-order"
                                    class="lookup-form">
                                    <input type="text" name="code" class="form-control"
                                        placeholder="Mã d?t bàn (VD: BK-2026-001)" value="${param.code}" required>
                                ...
                                <p style="font-size:13px;color:var(--text-muted);margin-top:12px">
                                    <i class="fa-solid fa-info-circle"></i> B?n c?n có mã d?t bàn d? d?t món tru?c.
                                    <a href="${pageContext.request.contextPath}/user/booking/create"
                                        style="color:var(--primary)">Ð?t bàn ngay ?</a>
                                </p>
                            </div>
                        </c:when>
                            ...
                            <div class="preorder-grid">
                                ...
                                <div class="menu-panel">
                                    <div class="menu-panel-header">
                                        <h3><i class="fa-solid fa-bowl-food" style="color:var(--primary)"></i> Ch?n món
                                        </h3>
                                    ...
                                    <div class="menu-list" id="menuList">
                                        ...
                                        <c:if test="${empty menuItems}">
                                            <div class="cart-empty"><i class="fa-solid fa-bowl-food"></i>Chua có món nào
                                            </div>
                                        </c:if>
                                    </div>
                                </div>
                                ...
                                <div class="cart-panel">
                                    ...
                                    <div class="cart-body" id="cartBody">
                                        <div class="cart-empty" id="cartEmpty">
                                            ...
                                            Chua có món nào.<br>Ch?n món t? danh sách bên trái.
                                        </div>
                                    </div>
                                    <div class="cart-footer">
                                        <div class="cart-total-row">
                                            <span class="cart-total-label">T?m tính</span>
                                            <span class="cart-total-value" id="cartTotal">0d</span>
                                        </div>
                                        <div class="cart-note">
                                            <textarea id="preorderNote"
                                                placeholder="Ghi chú (d? ?ng, yêu c?u d?c bi?t...)"></textarea>
                                        </div>
                                        <button type="button" class="btn-confirm-preorder" id="btnConfirm" disabled
                                            onclick="confirmPreOrder()">
                                            <i class="fa-solid fa-check"></i> Xác nh?n d?t món
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="footer-grid">
                        <div class="footer-brand">
                            <div class="footer-logo">
                                ...
                                <div class="footer-logo-text">Huong Vi?t<span>Nhà hàng &amp; Quán nh?u</span></div>
                            </div>
                            <p class="footer-desc">Không ch? là nhà hàng, Huong Vi?t còn là phong cách s?ng — di?m h?n c?a nh?ng kho?nh kh?c dáng nh?.</p>
                            <div class="socials">
                        ...
                        <div class="footer-col">
                            ...
                            <ul>
                                ...
                                <li><a href="${pageContext.request.contextPath}/user/booking/create">Ð?t bàn</a></li>
                                <li><a href="${pageContext.request.contextPath}/user/booking/status">Tra c?u booking</a></li>
                                <li><a href="${pageContext.request.contextPath}/user/pre-order">Ð?t món tru?c</a></li>
                            </ul>
                        </div>
                        <div class="footer-col">
                            <h4>V? chúng tôi</h4>
                            <ul>
                                ...
                                <li><a href="${pageContext.request.contextPath}/contact">Liên h?</a></li>
                            </ul>
                        </div>
                        <div class="footer-col">
                            <h4>Liên h?</h4>
                            <div class="footer-contact-item">
                                ...
                                <div class="footer-contact-text"><strong>Ð?a ch?</strong>123 Nguy?n Hu?, Qu?n 1, TP.HCM</div>
                            </div>
                            <div class="footer-contact-item">
                            ...
                            <div class="footer-contact-item">
                                ...
                                <div class="footer-contact-text"><strong>Gi? m? c?a</strong>10:00 – 23:00 hàng ngày</div>
                            </div>
                        </div>
                    </div>
                    <div class="footer-bottom">
                        <p>© 2026 Nhà hàng Huong Vi?t.</p>
                        <p>Thi?t k? b?i <a href="#">Ð?i ngu Huong Vi?t Tech</a></p>
                    </div>
                </footer>
