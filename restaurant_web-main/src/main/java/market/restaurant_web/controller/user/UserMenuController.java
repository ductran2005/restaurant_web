...
/**
 * User menu page — /user/menu
 * Reuses the same ProductService/CategoryService logic as PublicMenuController.
 * Points to user/menu.jsp which uses the user navbar.
 */
