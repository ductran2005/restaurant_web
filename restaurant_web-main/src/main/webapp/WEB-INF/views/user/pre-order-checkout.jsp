        ...
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <body>
                ...
                <nav class="nav">
                    ...
                    <div class="nav-links">
                        <a href="${pageContext.request.contextPath}/user/menu"><i class="fa-regular fa-book-open"></i> Thực
                            đơn</a>
                        <a href="${pageContext.request.contextPath}/user/booking/create"><i class="fa-regular fa-calendar"></i> Đặt
                            bàn</a>
                        <a href="${pageContext.request.contextPath}/user/booking/status"><i
                                class="fa-solid fa-magnifying-glass"></i> Tra cứu</a>
                        <a href="${pageContext.request.contextPath}/user/pre-order" class="active">
                ...
                <div class="page">
                    ...
                    <!-- Back -->
                    <a href="${pageContext.request.contextPath}/user/pre-order?code=${booking.bookingCode}"
                        class="back-link">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <c:forEach var="poi" items="${items}">
                                            <c:if test="${not empty poi and not empty poi.product}">
                                                <div class="item-row">
                                                    <div class="item-thumb"><i class="fa-solid fa-bowl-food"></i></div>
                                                    <div class="item-info">
                                                        <div class="item-name">
                                                            <c:out value="${poi.product.productName}" />
                                                        </div>
                                                        <div class="item-unit">
                        ...
                        <div>
                            ...
                            <div class="card">
                                ...
                                <form id="payForm" method="post"
                                    action="${pageContext.request.contextPath}/user/pre-order/checkout">
