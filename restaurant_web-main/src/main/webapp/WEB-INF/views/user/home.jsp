...
<nav class="navbar" id="navbar">
    ...
    <div class="nav-actions">
        ...
        <a href="${pageContext.request.contextPath}/logout" class="btn-book" style="background:#c0392b">
...
<section class="hero">
    ...
    <div class="hero-content">
        ...
        <div class="hero-cta">
            <a href="${pageContext.request.contextPath}/user/menu" class="btn-primary">
                <i class="fa-solid fa-book-open"></i> Xem thực đơn
            </a>
            <a href="${pageContext.request.contextPath}/user/booking/create" class="btn-outline">
    ...
    <div class="dishes-ticker" id="ticker">
        <div class="ticker-set">
            <div class="ticker-item">
                ...
                <div><div class="ticker-item-name">Gỏi cuốn tôm thịt</div><div class="ticker-item-price">65.000 đ</div></div>
                <span class="ticker-item-tag">Khai vị</span>
            </div>
            <div class="ticker-item">
                <img src="${pageContext.request.contextPath}/assets/img/dish2.png" alt="Bò lúc lắc">
                <div><div class="ticker-item-name">Bò lúc lắc sốt tiêu đen</div><div class="ticker-item-price">185.000 đ</div></div>
                <span class="ticker-item-tag">Món hot</span>
            </div>
            <div class="ticker-item">
                <img src="${pageContext.request.contextPath}/assets/img/dish3.png" alt="Hải sản">
                <div><div class="ticker-item-name">Mâm hải sản tươi sống</div><div class="ticker-item-price">320.000 đ</div></div>
                <span class="ticker-item-tag">Đặc sản</span>
            </div>
            <div class="ticker-item">
                <img src="${pageContext.request.contextPath}/assets/img/dish4.png" alt="Lẩu">
                <div><div class="ticker-item-name">Lẩu gà đen nấm rừng</div><div class="ticker-item-price">280.000 đ</div></div>
                <span class="ticker-item-tag">Mới ra</span>
            </div>
            <div class="ticker-item">
                <img src="${pageContext.request.contextPath}/assets/img/dish1.png" alt="Gỏi">
                <div><div class="ticker-item-name">Gỏi bò cà pháo đồng quê</div><div class="ticker-item-price">95.000 đ</div></div>
                <span class="ticker-item-tag">Khai vị</span>
            </div>
            <div class="ticker-item">
                <img src="${pageContext.request.contextPath}/assets/img/dish2.png" alt="Nướng">
                <div><div class="ticker-item-name">Nầm sữa cháy tỏi</div><div class="ticker-item-price">145.000 đ</div></div>
                <span class="ticker-item-tag">Best Seller</span>
            </div>
            <div class="ticker-item">
                <img src="${pageContext.request.contextPath}/assets/img/dish3.png" alt="Ghẹ">
                <div><div class="ticker-item-name">Ghẹ rang muối otoro</div><div class="ticker-item-price">250.000 đ</div></div>
                <span class="ticker-item-tag">Hải sản</span>
            </div>
            <div class="ticker-item">
                <img src="${pageContext.request.contextPath}/assets/img/dish4.png" alt="Lẩu Thái">
                <div><div class="ticker-item-name">Lẩu Thái hải sản cay đặc biệt</div><div class="ticker-item-price">299.000 đ</div></div>
...
<section class="menu-section" id="menu">
    <div class="section-head">
        ...
        <h2 class="section-title">Tinh hoa ẩm thực <em style="font-style:italic;color:var(--primary)">ba miền</em></h2>
        <p class="section-subtitle">Hơn 50 món ăn được chế biến từ nguyên liệu tươi ngon mỗi ngày bởi đội bếp có kinh nghiệm hơn 10 năm.</p>
    </div>
    <div class="menu-grid">
        <div class="menu-card">
            ...
            <div class="menu-card-body">
                ...
                <p class="menu-card-desc">Gỏi cuốn tươi với tôm sú và thịt heo, rau sống và bún, chấm nước mắm chua ngọt đặc biệt.</p>
                <div class="menu-card-footer">
                    <div class="menu-card-price">65.000<span>đ</span></div>
                    <a href="${pageContext.request.contextPath}/user/menu" class="btn-add-dish"><i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        <div class="menu-card">
            ...
            <div class="menu-card-body">
                ...
                <p class="menu-card-desc">Thăn bò Úc cao cấp, xào cùng bơ tỏi phi thơm, tiêu đen Phú Quốc, ăn kèm cơm chiên.</p>
                <div class="menu-card-footer">
        ...
        <div class="menu-card">
            ...
            <div class="menu-card-body">
                ...
                <p class="menu-card-desc">Tôm hùm, ghẹ gạch, nghêu hấp xả, mực nướng sa tế — đặt trước để có giá tốt nhất.</p>
                <div class="menu-card-footer">
        ...
        <div class="menu-card">
            ...
            <div class="menu-card-body">
                ...
                <p class="menu-card-desc">Gà đen hầm cùng nấm rừng Vân Nam trong nước dùng trong vắt, ngọt thanh, bổ dưỡng.</p>
                <div class="menu-card-footer">
    ...
    <div class="view-all-wrap">
        <a href="${pageContext.request.contextPath}/user/menu" class="btn-outline" style="display:inline-flex">
...
<section class="about-section" id="about">
    <div class="about-grid">
        ...
        <div class="about-content">
            ...
            <h2 class="section-title">Hơn một thập kỷ giữ hương vị <em style="color:var(--primary);font-style:italic">quê nhà</em></h2>
            <p class="section-subtitle">Từ năm 2014, Hương Việt đã trở thành điểm hẹn quen thuộc của hàng nghìn gia đình và nhóm bạn tại TP.HCM — nơi giao thoa giữa ẩm thực dân dã và không gian hiện đại.</p>
            <div class="features">
                <div class="feature">
                    <div class="feature-icon"><i class="fa-solid fa-wheat-awn"></i></div>
                    <div>
                        <div class="feature-title">Nguyên liệu tươi sống mỗi ngày</div>
                        <div class="feature-desc">Nhập hàng trực tiếp từ chợ đầu mối Bình Điền, không qua trung gian, đảm bảo độ tươi ngon.</div>
                    </div>
                </div>
                <div class="feature">
                    ...
                    <div>
                        ...
                        <div class="feature-desc">Đội ngũ đầu bếp được đào tạo bài bản, am hiểu ẩm thực từng vùng miền của Việt Nam.</div>
                    </div>
                </div>
                <div class="feature">
                    ...
                    <div>
                        ...
                        <div class="feature-desc">Có phòng VIP riêng tư, sảnh tiệc cho tổ chức sự kiện lớn nhỏ, liên hoan cuối năm.</div>
                    </div>
                </div>
            </div>
        </div>
...
<section class="promo-section">
    ...
    <div class="promo-grid">
        <div class="promo-card">
            <div class="promo-card-bg"><img src="${pageContext.request.contextPath}/assets/img/dish3.png" alt=""></div>
            <div class="promo-card-body">
                ...
                <a href="${pageContext.request.contextPath}/user/booking/create" class="btn-promo">
                    <i class="fa-solid fa-calendar-check"></i> Đặt bàn ngay
                </a>
            </div>
        </div>
        <div class="promo-card">
            <div class="promo-card-bg"><img src="${pageContext.request.contextPath}/assets/img/dish4.png" alt=""></div>
            <div class="promo-card-body">
        ...
        <div class="promo-card">
            <div class="promo-card-bg"><img src="${pageContext.request.contextPath}/assets/img/dish2.png" alt=""></div>
            <div class="promo-card-body">
                <span class="promo-tag">🥂 Liên hoan</span>
                <h3 class="promo-title">Set liên hoan nhóm từ 8 người</h3>
                <p class="promo-desc">Set riêng cho nhóm bạn, đồng nghiệp — đủ món, đủ vui từ 2.500.000 đ/bàn.</p>
                <a href="${pageContext.request.contextPath}/user/booking/create" class="btn-promo">
...
<section class="cta-section" id="contact">
    ...
    <form class="cta-form" action="${pageContext.request.contextPath}/user/booking/create" method="get">
...
<a href="${pageContext.request.contextPath}/user/booking/create" class="float-book">
    <i class="fa-solid fa-calendar-check"></i> Đặt bàn ngay
</a>
